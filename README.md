...
Planning and documentation. No production cutover is represented by this repository yet.
...
- Keep the deployment KISS: one Docker host, one Docker Compose project, one shared application network.
